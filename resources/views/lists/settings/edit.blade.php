    ...
    <section>
        <div class="container">
            <h2 class="text-dark pt-5" style="width: 100%; border-bottom: 1px solid rgb(214, 214, 214); line-height: 0.1em; margin: 10px 0px 30px;">
                <span style="background: rgb(255, 255, 255); padding-right: 14px;">Edit List: {{ $list->title }}</span>
            </h2>
        </div>
        <div class="pt-5 pb-5">
                    ...
                    <div class="column-admin col-12 col-md-9 col-lg-7 col-xl-6">
                        ...
                        <aside>
                            <ul class="list-unstyled">
                                <li>
                                    <a class="btn btn-secondary me-3 custom" href="/settings/lists">All Lists</a>
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card bg-light" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <form method="POST" action="/lists/settings/{{ $list->id }}/update">
                                    @csrf
                                    @method('PATCH')

                                    <x-form-movie.input name="title" :value="old('title', $list->title)" />
